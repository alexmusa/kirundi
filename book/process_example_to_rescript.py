...
def main():
    ...
    for file_num in range(start_num, end_num + 1):
        ...
        filename = f"content_{file_num:03d}.txt"
        input_file = input_dir / filename
        output_file = output_dir / f"examples_{file_num:03d}.res.component"
...
Based of the given lesson, extract examples in the following format for Rescript. Only output the examplesData: examples code and nothing else.

type examples = array<(string, string)>"""
