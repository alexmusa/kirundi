...
function Lesson30$Content(props) {
  return JsxRuntime.jsx(JsxRuntime.Fragment, {});
}

let Content = {
  make: Lesson30$Content
};
...
let quizData = [
  ...
  },
  {
    ...
    questions: [
      {
        prompt: "urugi",
        answer: "urugi rwanje (my door) - inzugi zanje (my doors)"
      },
      {
        prompt: "uruzi",
        answer: "uruzi rwanje (my river) - inzuzi zanje (my rivers)"
      },
      {
        prompt: "umugozi",
        answer: "umugozi wanje (my rope) - imigozi yanje (my ropes)"
      },
      {
        prompt: "urukwi",
        answer: "urukwi rwanje (my stick of wood) - inkwi zanje (my firewood)"
      },
      {
        prompt: "akazi",
        answer: "akazi kanje (my work) - (no plural)"
      },
      {
        prompt: "urutoke",
        answer: "urutoke rwanje (my finger) - intoke zanje (my fingers)"
      },
      {
        prompt: "umutunzi",
        answer: "umutunzi wanje (my rich man) - abatunzi banje (my rich men)"
      },
      {
        prompt: "ubusho",
        answer: "ubusho bwanje (my herd) - (no plural)"
      },
      {
        prompt: "ururimi",
        answer: "ururimi rwanje (my tongue/language) - indimi zanje (my languages)"
      },
      {
        prompt: "urwara",
        answer: "urwara rwanje (my fingernail) - inzara zanje (my fingernails)"
      },
      {
        prompt: "akayabo",
        answer: "akayabo kanje (my cat) - utuyabo twanje (my cats)"
      },
      {
        prompt: "akanwa",
        answer: "akanwa kanje (my mouth) - utunwa twanje (my mouths)"
      },
      {
        prompt: "ubwato",
        answer: "ubwato bwanje (my boat) - amato yanje (my boats)"
      },
      {
        prompt: "uburyo",
        answer: "uburyo bwanje (my way/opportunity) - (no plural)"
      },
      {
        prompt: "uburiri",
        answer: "uburiri bwanje (my bed) - amariri yanje (my beds)"
      }
    ]
  },
  {
    ...
    questions: [
      {
        prompt: "ubutumwa",
        answer: "ubutumwa bwiza (good message)"
      },
      {
        prompt: "umuyaga",
        answer: "umuyaga mwiza (good wind) - imiyaga myiza (good winds)"
      },
      {
        prompt: "uruyoya",
        answer: "uruyoya rwiza (good infant) - inyoya nziza (good infants)"
      },
      {
        prompt: "ubushaza",
        answer: "ubushaza bwiza (good peas)"
      },
      {
        prompt: "ijambo",
        answer: "ijambo ryiza (good word) - amajambo meza (good words)"
      },
      {
        prompt: "akantu",
        answer: "akantu keza (good little thing) - utuntu twiza (good little things)"
      },
      {
        prompt: "icete",
        answer: "icete ciza (good letter) - amarete meza (good letters)"
      },
      {
        prompt: "ubwoya",
        answer: "ubwoya bwiza (good fur/hair)"
      },
      {
        prompt: "amata",
        answer: "amata meza (good milk)"
      },
      {
        prompt: "agakiza",
        answer: "agakiza keza (good salvation)"
      },
      {
        prompt: "urusato",
        answer: "urusato rwiza (good skin) - insato nziza (good skins)"
      },
      {
        prompt: "inkoko",
        answer: "inkoko nziza (good chicken/chickens)"
      },
      {
        prompt: "urubaho",
        answer: "urubaho rwiza (good board) - imbaho nziza (good boards)"
      },
      {
        prompt: "ubufu",
        answer: "ubufu bwiza (good flour)"
      },
      {
        prompt: "umusi",
        answer: "umusi mwiza (good day) - imisi myiza (good days)"
      }
    ]
  },
  {
...
let l_content = JsxRuntime.jsx(Lesson30$Content, {});
